...
<a href="https://store.steampowered.com/app/3891070/Omega_Protocol_Demo/">
  <img src="https://github.com/kofeeel/OmegaProtocol/blob/main/Image/omegaimage.png?raw=true" width="100%"/>
</a>

**GAS 기반 3인 협동 로그라이트 슈터 · Steam Demo 출시**

`UE5` `GAS` `C++` `Perforce` · 프로그래머 5인 · 8주

[![Steam](https://img.shields.io/badge/Steam-Demo-1b2838?style=flat-square&logo=steam)](https://store.steampowered.com/app/3891070/Omega_Protocol_Demo/)
[![YouTube](https://img.shields.io/badge/YouTube-영상-FF0000?style=flat-square&logo=youtube)](https://youtu.be/Iia-4RZ8x-8?si=UYuBpHaU8vrV6uMW)

| 담당 | 내용 |
|:--|:--|
| 전투 | ExecCalc 중앙화, 20종 스킬 단일 파이프라인 |
| 네트워크 | NetSerialize 비트패킹으로 패킷 평균 **24%↓** (82.7→62.7B) |
| 렌더링 | GameplayCue 전환으로 부하 **~67%↓** |
| 데이터 | DataTable/CurveTable 기반 밸런싱 |
| 기획 | 캐릭터·스킬 기획, 레벨 5개 스테이지 제작 |
...
<a href="https://kofeeel.itch.io/transmundus">
  <img src="https://github.com/leebo155/RunBetterRun/raw/main/screenshots/main.png" width="100%"/>
</a>

**C++ 레이캐스팅 기반 2.5D 공포 탈출게임**

`C++` `WinAPI` `SDL` `Git` · 프로그래머 4인 · 2주

[![itch.io](https://img.shields.io/badge/itch.io-플레이-FA5C5C?style=flat-square&logo=itchdotio)](https://kofeeel.itch.io/transmundus)

| 담당 | 내용 |
|:--|:--|
| 에디터 | 5모드 타일맵 에디터, 뷰포트 컬링 |
| 직렬화 | 바이너리(.dat) 저장, 시그니처 검증 |
| 아키텍처 | 에디터↔게임 분리, 좌표 변환 시스템 |
| 안정성 | DDA ray.distance=0 크래시 원천 차단 |
